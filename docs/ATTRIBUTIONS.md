...
- **Version**: v1.1.11
- **Usage**: Decoding HEIC file types. For this project, the library has been recompiled from the original ES module to be compatible with a vanilla JavaScript environment. ([See changes](https://github.com/hoppergee/heic-to/pull/13/commits/72c663fc746094ad68c7a8533d34e900f205268b))
